...
```{r Ch3L.5, fig.height = 4, fig.width = 6, fig.cap = "Figure 3L.5. Distribution of size in Cypripedium candidum"}
...
```{r Ch3L.43, fig.height = 4, fig.width = 6, fig.cap = "Figure 3L.8. Ahistorical vs. historical, raw lambda"}
...
```{r Ch3L.44, fig.height = 4, fig.width = 6, fig.cap = "Figure 3L.9. Ahistorical vs. historical, function-based lambda"}
...
```{r Ch3L.47, fig.height = 4, fig.width = 6, fig.cap = "Figure 3L.10. Ahistorical vs. historically-corrected stable and long-run mean stage distribution, raw MPMs"}
...
```{r Ch3L.48, fig.height = 4, fig.width = 6, fig.cap = "Figure 3L.11. Ahistorical vs. historically-corrected stable and long-run mean stage distribution, function-based MPMs"}
...
```{r Ch3L.49, fig.height = 4, fig.width = 6, fig.cap = "Figure 3L.12. Ahistorical stable and long-run mean stage distribution, function-based MPMs with wrong size and fecundity distributions"}
...
```{r Ch3L.50, fig.height = 4, fig.width = 6, fig.cap = "Figure 3L.13. Ahistorical vs. historically-corrected deterministic and stochastic reproductive values, raw MPMs"}
...
```{r Ch3L.58, fig.height = 4, fig.width = 6, fig.cap = "Figure 3L.15. Ahistorical vs. historically-corrected deterministic and stochastic elasticity to stage, function-based"}
...
```{r Ch3L.59, fig.height = 4, fig.width = 6, fig.cap = "Figure 3L.16. Ahistorical vs. historically-corrected elasticity of lambda to transitions, function-based"}
...
```{r Ch3L.60, fig.height = 4, fig.width = 6, fig.cap = "Figure 3L.17. Elasticity of lambda to historical transitions, function-based"}
