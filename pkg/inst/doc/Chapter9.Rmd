...
```r
trialltre_det <- ltre3(anth_lmean, stochastic = FALSE, steps = 10000,
...
![Figure 9.3. LTRE contributions by stage](Ch9.10-1.png)
  ...
  <p style="text-indent: 20px">The output above shows that large flowering adults exerted the strongest influence on both $\lambda$ and $\text{log} \lambda$, with the latter influence being through the impact of shifts in the mean. This impact is overwhelmingly negative. The next largest impact comes from small flowering adults, in both cases the influence being negative on the whole.</p>
...
![Figure 9.4. LTRE contributions by transition type](Ch9.11-1.png)
  ...
  <p style="text-indent: 20px">The overall greatest impact on the population growth rate is from fecundity, and these contributions are overwhelmingly negative. Clearly temporal variation has strong effects here that deserve to be assessed properly.</p>
