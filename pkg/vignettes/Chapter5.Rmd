...
cypann3s
#>   pop patch          a         var         sd           se
#> 1   1  <NA> -0.0401626 0.002337849 0.04835131 0.0004835131
```
...
which(as.matrix(tm3sens$h_sensmats[[1]]) == 
  max(as.matrix(tm3sens$h_sensmats[[1]])[which(as.matrix(tmeans3r$A[[1]]) > 0)]))
#> [1] 962658 962712 962982 963306 963522 963630 963792
# The highest stochastic sensitivity value:
...
which(as.matrix(tm3sens_s$h_sensmats[[1]]) == 
  max(as.matrix(tm3sens_s$h_sensmats[[1]])[which(as.matrix(tmeans3r$A[[1]]) > 0)]))
#>  [1] 962604 962658 962712 962766 962820 962874 962928 962982 963036 963090 963144 963198 963252 963306 963360
#> [16] 963414 963468 963522 963576 963630 963684 963738 963792 963846 963900
