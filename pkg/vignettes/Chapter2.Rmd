...
![Figure 2.7. Ahistorical vs. historically-corrected deterministic and stochastic elasticity to transitions](Ch2.40-1.png)
  ...
  <p style="text-indent: 20px">Package `lefko3` also includes functions to conduct deterministic and stochastic life table response experiments. Users wishing to conduct these analyses should see our new vignettes on this topic.</p>
