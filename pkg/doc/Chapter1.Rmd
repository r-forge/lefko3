...
#### Further analyses   
  ...
  <p style="text-indent: 20px">Package `lefko3` includes two general projection functions, `projection3()` and `f_projection3()`. The former projects matrices that have already been created, while the latter creates new function-based MPMs (including IPMs) at each time step. These functions both include the capability to conduct replicate simulations, as well as density dependence. Unlike other packages and methods, these functions are engineered for speed, and also include the capability to enforce substochasticity. Please see our book, **lefko3: a gentle introduction**, for more details (on the <a href = "http://www.sheffersonlab.com/projects.html">Projects page</a> of www.sheffersonlab.com).</p>
