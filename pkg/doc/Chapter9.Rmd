...
```{r Ch9.12, fig.height = 4, fig.width = 6, fig.cap = "Figure 9.2. Deterministic vs. stochastic lambda"}
...
```{r Ch9.16, fig.height = 4, fig.width = 6, fig.cap = "Figure 9.3. LTRE contributions by stage in population C"}
...
```{r Ch9.17, fig.height = 4, fig.width = 6, fig.cap = "Figure 9.4. LTRE contributions by transition type in population C"}
...
```{r Ch9.19, fig.height = 4, fig.width = 6, fig.cap = "Figure 9.5. Mean element sLTRE contributions by transition type"}
...
```{r Ch9.20, fig.height = 4, fig.width = 6, fig.cap = "Figure 9.6. Element SD sLTRE contributions by transition type"}
