...
cypann3s
#>   pop patch           a         var        sd          se
#> 1   1     1 -0.03980719 0.002287087 0.0478235 0.000478235
```
...
![Figure 5.7. Ahistorical vs. historically-corrected deterministic and stochastic reproductive values](Ch5.21-1.png)
  ...
  <p style="text-indent: 20px">We see some big differences here. Particularly, it appears that ahistorical analyses both suggest reproductive value to some of the juvenile stages, most notably seedlings and 3rd year protocorms. Historical analysis show virtually no reproductive value to those stages, in contrast. Interesting results in need of further study!</p>
...
#> The highest deterministic sensitivity value: 0.050713506274519
writeLines(paste0("This value is associated with element: ",
...
#> The highest stochastic sensitivity value: 0.0521984685583052
writeLines(paste0("This value is associated with element: ",
...
#> The highest deterministic sensitivity value (historically-corrected): 0.198350506637601
writeLines(paste0("This value is associated with element: ",
...
#> The highest stochastic sensitivity value (historically-corrected): 0.20570300398604
writeLines(paste0("This value is associated with element: ",
...
![Figure 5.10. Projections of Cypripedium population against boosted fecundity](Ch5.29-1.png)
